        ...
        function showUpgradePrompt(reason){
          ...
          ov.style.cssText='position:fixed;inset:0;z-index:1000;background:rgba(8,7,6,0.98);backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px);display:flex;align-items:center;justify-content:center;padding:20px';
          ...
          ov.innerHTML='<div style="background:rgba(12,11,9,0.97);border:0.5px solid rgba(201,168,76,0.2);border-radius:20px;max-width:360px;width:100%;padding:28px 24px;text-align:center">'
            ...
            +'<div style="font-size:18px;font-weight:700;color:#fff;margin-bottom:8px;font-family:var(--font-serif,serif)">'+(_titles[reason]||'Premium feature')+'</div>'
            +'<div style="font-size:13px;color:rgba(255,255,255,0.65);line-height:1.6;margin-bottom:20px">'+(_bodies[reason]||'This feature is part of a premium plan.')+'</div>'
